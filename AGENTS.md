...
- On 2026-09-14, adapter 95 / live pipeline 100 adds twelve output-blind cross-phase puzzle roots and eleven fixed source-game contexts, with 104 fresh engine searches and four six-piece Syzygy queries. A quiet pawn push now explains Promotion Clearance through twenty root replies and 38 continuation witnesses in 488 of 4,096 shared operations. Its later fork, payoff, countercapture and promotion stay at their actual plies; unused pawn-skewer noise and inflated independent gains are removed only on the matched proof path. Root/missed evidence does not expand unsupported causal comparisons. Four contrary controls reject the certificate; a genuine larger-ending zugzwang and four other sampled roots remain coverage gaps, not correct negatives. All 246 private full results, twenty prior rare results, 32 priorities, 310 prior public headline lists and twenty-two other new full results are unchanged, not certified accurate. Verification: 1,748 selected tests, 867 actual-controller worker inputs, builds, TypeScript, sixteen-file lint, three service tests, two cache scenarios and eighteen isolated HTTP cases pass. Public worker median/p95/max is 78/209/639 ms excluding engine/UI; first HTTP startup is 1,532 ms and previous multi-second variability remains contrary evidence. See benchmarks/tactical-relevance/cross-phase-relevance-review.md and private-course-review.md. Broader quiet/secondary/positional/endgame and causal gaps remain; no owner app/package/service restart, deployment or native verification. Paid data stays private.
