...
- On 2026-09-14, adapter 88 / live pipeline 93 independently verifies capturing mate threats and same-square mating compensation under shared 8,192-visit bounds. Initial captures, defensive promotions and all friendly-piece liabilities are counted; an off-piece guard capture must restore the exact nominated mate. One course root loses its false free-bishop headline without inventing a defensive/only-move lesson, while the opponent's recapture attack stays at its actual ply. A second root gains Mating Attack rather than borrowing its accepting mate or calling one queen target a fork. All 199 other course results, 24 generated-game results, twenty rare cases, 32 priorities and 162 prior public headlines remain unchanged, not certified accurate. Ninety-three fresh depth-16 searches review both real proof trees and contrary controls; local material bounds remain distinct from full-position evaluations. Verification: 1,489 selected tests, eighteen private proof/replay checks, 631 production-worker inputs, builds, lint, type checking, three service tests and two dev-cache scenarios pass. Public worker median/p95/max is 78/216/600 ms excluding engine/UI; six isolated HTTP cases pass with first/next startup 1,373/69 ms, not native reliability proof. See benchmarks/tactical-relevance/capturing-mating-attack-review.md and private-course-review.md. Earlier provisional defensive-capture wording is explicitly corrected; longer quiet combinations, positional pin distinctions, broader causal coverage and drawing/larger-ending zugzwangs remain open. No app/package/service was restarted or deployed; paid data stays private.
