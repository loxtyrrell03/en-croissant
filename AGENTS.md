...
- On 2026-09-14, adapter 100 / live pipeline 105 accepts independently validated exact-position Syzygy pass certificates for larger-ending winning/drawing zugzwang. The explicit Tactics Verify move online action keeps local results, original engine context and bounded Cancel/Retry; normal scans do not upload positions. Every legal move, promotion, terminal flag, clock and outcome comparison is checked; unknown results do not become negatives. Two real roots, a colour reflection and a reciprocal drawing resource qualify across 22 development cases; source-tagged infiltration/pawn wins and same-outcome controls do not. Fifty-two fresh tablebase queries, corrected initial queen/bishop judgements and retained contrary receipts are documented. Missed/allowed adapter lessons require supplied evidence, and causal blame requires an independent better-position outcome; automatic game-review lookup is not wired. All 246 private source/live results, twenty rare results, 32 priorities and 527 previous public headlines remain unchanged, not certified accurate. Verification: 1,895 selected tests, 1,055 controller-worker inputs, eight real-browser renderer groups including narrow/200% and recovery states, 29 isolated HTTP cases, builds, TypeScript, sixteen-file lint, three service tests and two cache scenarios pass. Final public worker median/p95/max is 72/225/844 ms excluding engine/network/native UI; deadlines stay unchanged. See benchmarks/tactical-relevance/tablebase-relevance-review.md and private-course-review.md for proof boundaries, receipts and limitations. Broader positional/quiet/causal and native gaps remain open. No owner app/package/service restart or deployment; paid material stays private.
