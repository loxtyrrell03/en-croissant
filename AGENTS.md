...
- On 2026-09-12, adapter 79 / live pipeline 84 recovers a two-ray discovery through independently mating off-square countercaptures under the shared, unchanged 4,096-visit budget. Generic free-piece claims now require surviving positive countercapture refutations; replay-matching discovery/fork compensation stays neutral, and duplicate uncovered-check/intermediate-check lessons are combined. A new disjoint 21-position positional sample brings course coverage to 159 development positions, not an accuracy percentage. One real root is recovered and one false knight-gain headline is withdrawn; 135 of the prior 138 full source/live results and all 32 primary priorities are unchanged, with two secondary explanations refined. Verification: 112 supplemental fresh engine searches, 1,286 selected tests, 441 controller-worker inputs, builds, lint, three service tests and two dev-cache scenarios pass. Public worker median/p95/max is 77/229/519 ms excluding engine/UI; cold HTTP first/next startup is 7,462/62 ms. See benchmarks/tactical-relevance/private-course-review.md and the private adapter79-human-review.md for contrary evidence and bounded-proof limits. The unrelated OTB type error, broader quiet/rare/causal gaps and native verification remain open. No app/package/service was restarted or deployed; paid data stays private.
