...
- The 2026-09-08 Nd7 causal investigation now has fresh unrestricted depth-16 evidence in `double-threat-defence-stockfish-18.json`. After g6/Nd7, Black's best score is -300 cp; after Bg6/Nd7, Stockfish prefers Raxa6 at +485 cp. Nd7 vacates the bishop's defender; Raxa6 captures that bishop while the rooks can recapture for each other, and keeping g7 permits Nf6+ gxf6. Legal branch regressions show Raxa6 bxa6 Rxa6 still concedes 70 cp locally, whereas Raxa6 Nxb6 Rxb6 gains Black 150 cp. These are not the full engine evaluations. The fresh diagnostic and two legal-replay tests pass. This is evidence for the next causal-proof refinement, not a shipped classifier change: the general countercapture escape attempt was withheld because it did not prove all relevant branches without disturbing an earlier discovered-attack defence. Preserve accumulated material credit through checking-fork recaptures, include captures beyond named victims, and do not treat failure to prove an alternate attack as proof of prevention. Nd7 after g6 and Bh7+ after Qxd4 remain causally unproved in adapter 34; the live timeout fix is independent.
