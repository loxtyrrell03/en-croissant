...
- On 2026-09-14, adapter 102 / live pipeline 107 fixes a legal castling crash found in an all-defence rare-puzzle audit. Replay normalizes only equivalent legal king-landing actions while retaining UCI identity; compound-move proof guards abstain safely. Live arrows show both actual castling moves and the correct label square, not the rook corner. Eighteen output-blind real-game castling options plus three rare-root audits receive 96 final fresh engine searches. Ordinary checks/pins remain unlabelled; missed queen-rook forks, loose-bishop causation and missed castling mates have explicit checks. All 246 private full source/live results, twenty rare results, 32 priorities and 597 prior public headlines remain unchanged, not certified accurate. Verification: 1,992 selected tests, 1,233 controller-worker inputs, 96 actual-Chrome groups at narrow/200% with keyboard preview, 53 isolated HTTP cases, builds, TypeScript, fifteen-file lint, three service tests and two cache scenarios pass. Public worker mean/median/p95/max is 92/66/202/848 ms excluding engine/network/native UI; deadlines are unchanged. Cold first/next startup is 9,169/206 ms plus 13,319 ms server startup, so startup variability remains unresolved. Three rare root preparations and broader quiet/causal/endgame/Chess960/native coverage remain open; a failed mating-trap experiment was withdrawn. See benchmarks/tactical-relevance/castling-relevance-review.md and private-course-review.md for judgements, contrary evidence and receipts. No owner app/package/service restart or deployment; paid material stays private.
