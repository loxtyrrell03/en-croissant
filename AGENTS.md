...
- On 2026-09-14, adapter 94 / live pipeline 99 verifies restored interference through one further cut of the same guard or capture of an actual added defender. Two real roots now own the primary explanation; the second cut stays secondary at its actual ply. Complete 43-plus-40 and 39-plus-43 reply proofs use 659 and 980 of 4,096 shared operations. All-friendly liabilities also reduce an older rook-gain bound by a pawn. The 268-search engine receipt retains four defensive counterfactuals and a fifth unsafe-payoff case with contrary mating evidence, not a certified correct negative. All 246 private full results, nineteen other rare results, sixteen other secondary-sample results and 32 priorities are unchanged, not certified accurate. Verification: 1,714 selected tests, 815 actual-controller worker inputs, builds, TypeScript, twelve-file lint, three service tests, two cache scenarios and fifteen isolated HTTP cases pass. Public worker median/p95/max is 78/181/526 ms excluding engine/UI; first HTTP startup is 1,500 ms but earlier 9,820 ms startup remains contrary evidence. See benchmarks/tactical-relevance/interference-relevance-review.md and private-course-review.md. Root/missed evidence does not expand unsupported causal comparisons. Prepared/positional/rare/causal and larger-ending gaps remain; no owner app/package/service restart, deployment or native verification. Paid data stays private.
