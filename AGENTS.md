...
- On 2026-09-14, adapter 87 / live pipeline 92 removes remote post-counterattack gains from first-move headlines/arrows while keeping actual-ply continuation evidence in live and missed/allowed review. A 45-position output-blind expansion spans 21 positional exercises and 24 opening/middlegame/ending boards from generated engine games; human judgements preceded outputs. Fresh payoff analysis also disproved a geometric skewer whose rook capture allows mate in three. Direct and continuation king-skewer proofs now reject that independently verified checking mate within existing shared budgets; the safe checking-fork preparation remains and a no-knight control restores the skewer. Benchmark castling notation and history propagation are corrected. All 201 course results, 23 other generated-game results, twenty rare cases, 32 priorities and 159 prior public headlines remain unchanged, not certified accurate. Verification: 75 fresh depth-16 searches plus eight castling controls; 1,474 selected tests and 625 production-worker inputs pass, alongside builds, lint, type checking, three service tests and two dev-cache scenarios. Public worker median/p95/max is 82/237/618 ms excluding engine/UI. Six final HTTP cases pass; earlier cold startup approached ten seconds and test-runner teardown warnings remain, so no native reliability claim. See benchmarks/tactical-relevance/counterplay-relevance-review.md and private-course-review.md. A defensive capture's forced later rook concession, broader quiet/rare/causal coverage and drawing/larger-ending zugzwangs remain open. No app/package/service was restarted or deployed; paid data stays private.
