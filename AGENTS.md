...
- On 2026-09-14, adapter 97 / live pipeline 102 hardens promotion combinations against unresolved pawn endings, counterchecking skewers and counterpromotions. A 116-position nearby diagnostic set and seventy final fresh engine searches expose three losing sacrifices admitted by adapter96 and a fourth development-only false claim; all four now abstain. The real root retains Promotion Combination, actual-ply promotion and missed lessons, while acceptance loses a misleading Winning Recapture badge. Its 21 replies use 207,931 operations with a 220-unit local bound; capture-first witnesses replace a drawing retreat. Only this proof's allowance rises from 131,072 to 262,144; worker deadlines are unchanged. Five winning variants remain unproved coverage misses, not accuracy gains. All 246 private full results, twenty rare results, 23 cross-phase full results, 32 priorities and 376 prior public headline lists are unchanged, not certified accurate. Verification: 1,785 selected source/review/render tests, 892 actual-controller worker inputs, builds, TypeScript, eleven-file lint, three service tests, two cache scenarios and 22 isolated HTTP cases pass. Public worker median/p95/max is 74/243/869 ms excluding engine/UI; final first HTTP startup is 1,431 ms, with an earlier 10,223 ms startup retained as unresolved contrary evidence. See benchmarks/tactical-relevance/promotion-counterplay-review.md and private-course-review.md. Broader quiet/secondary/positional/endgame/primary-choice/causal gaps remain; no owner app/package/service restart, deployment or native verification. Paid data stays private.
