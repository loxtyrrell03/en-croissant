...
- On 2026-09-14, adapter 99 / live pipeline 104 gives generic direct threats their own complete, liability-aware material bounds instead of PV values; captures/promotions, claimable draws and same-target discovery/trap duplication are checked. The real e7+ keeps Discovered Check primary, with actual promotion later. Thirty hash-selected checking captures across 155 frozen public opening/positional/tactical/ending boards receive 115 fresh engine searches including selected witnesses and constructed controls. A checking-pawn draft is rejected after its winning root conceals a losing quiet continuation; its inactive patch and contrary evidence are retained. All 246 private primary lists/live results remain unchanged; one source continuation loses a redundant threat beside Trapped Queen. Existing twenty rare, 23 cross-phase, 23 broader-context results, 32 priorities and 462 prior public headlines are unchanged, not certified accurate. Verification: 1,830 selected tests, 1,033 actual-controller worker inputs, builds, TypeScript, sixteen-file lint, three service tests, two cache scenarios and 27 isolated HTTP cases pass. Final public worker median/p95/max is 81/399/1,054 ms excluding engine/UI; cold startup remains variable and existing deadlines are unchanged. See benchmarks/tactical-relevance/direct-threat-relevance-review.md and private-course-review.md for precise changes, judgements, rejected evidence, receipts and limitations. Broader quiet/rare/positional/ending/causal and native gaps remain open; no owner app/package/service restart or deployment. Paid data stays private.
