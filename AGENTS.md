...
- On 2026-09-14, adapter 91 / live pipeline 96 adds 39 output-blind opening/positional roots and recovers a genuine discovered-check cause after ...f6. A connected checking proof covers all four defences in 7,596 of 8,192 operations; shorter completed proofs are reused, ordering is colour/file stable, and other pieces must join with check. Missed/allowed lessons and board arrows retain the root mechanism; heterogeneous continuations cannot borrow single-target causal comparisons. Ordinary development, recaptures and pressure remain quiet. A poisoned-bishop assumption was corrected; six new course judgements remain uncertain, not certified negatives. The completed 27-search witness audit supports all 21 chosen decisions and preserves contrary controls. All 246 course/generated-game full results, twenty rare results, 32 priorities and 198 prior public headlines remain unchanged. Verification: 1,628 selected tests, 724 production-worker inputs, builds, type checking, eight-file lint, three service tests, two cache scenarios and eight isolated HTTP cases pass. Public worker median/p95/max is 82/204/608 ms excluding engine/UI (different case mix); the common subset is 85/221/608 ms. Existing deadlines and other proof budgets are unchanged. See benchmarks/tactical-relevance/opening-discovery-relevance-review.md and private-course-review.md. Wider quiet/defensive/rare/causal classification, larger-ending zugzwang and native verification remain open. No owner app/package/service was restarted or deployed; paid data stays private.
