...
- On 2026-09-14, adapter 89 / live pipeline 94 makes pin/skewer leaves account for all friendly-piece liabilities and immediate terminal counterplay under unchanged budgets. Material-only terminal handling preserves drawing rescues without funding rays with synthetic mate values. A stronger verified discovery subsumes only its own same-ray victim; distinct smaller same-move pins/skewers stay secondary, including missed lessons and board labels. Two course continuations lose a false Pin or lower a Skewer bound; one real Lichess continuation loses a duplicate Skewer. All 225 source results, course primary IDs, 24 generated-game results, 32 priorities and 168 prior public headlines remain unchanged, not certified accurate. Thirty-five completed fresh depth-16 searches retain contrary evidence, including a corrected older test and rejected negative constructions. Verification: 1,500 selected tests, twelve final replay/ray checks, 640 production-worker inputs, builds, type checking, lint, three service tests and two dev-cache scenarios pass. Public worker median/p95/max is 78/237/568 ms excluding engine/UI; six isolated HTTP cases pass with first/next startup 1,374/65 ms, not native reliability proof. See benchmarks/tactical-relevance/ray-liability-relevance-review.md and private-course-review.md. Broader quiet/rare/causal and drawing/larger-ending zugzwang gaps remain; interference/exact KPK coverage is preserved, not expanded here. No app/package/service was restarted or deployed; paid data stays private.
