...
- On 2026-09-12, adapter 84 / live pipeline 89 adds exact local K+P-versus-K winning-zugzwang proofs: actual turn, pass counterfactual and every defence must agree. The full canonical legal move graph and winning/drawn equations are exhaustively checked. A separate all-reply capture proof makes the new Lichess root Winning Pawn Ending; Zugzwang stays at its actual ply, with matching board arrows and missed/allowed/persisting mistake ownership. Claimable fifty-move draws abstain before assuming a capture reset. Thirty fresh engine searches retain contrary best-move and larger-ending evidence; the incomplete larger-pawn search was withdrawn. All 180 prior full course source/live results, 20 rare results, 32 priorities and 141 prior public headlines remain unchanged, not certified accurate. Verification: 1,395 selected tests, 519 production-worker inputs, lint, builds, three service and two dev-cache tests pass. Public worker median/p95/max is 89/418/1,256 ms excluding engine/UI; four HTTP cases pass but first/KPK startup is 9,672/9,021 ms, not a startup fix. See benchmarks/tactical-relevance/kpk-zugzwang-review.md and private-course-review.md for exact proof scope and receipts. Drawing and larger-ending zugzwangs, broader quiet/rare/causal gaps, the unrelated OTB type error and native verification remain open. No app/package/service was restarted or deployed; paid data stays private.
