...
- On 2026-09-12, adapter 81 / live pipeline 86 adds independently checked forced self-interference and actual-ply mating king deflection. All-defence interference may lead the root; the defender's blocking move stays secondary. Mating deflection requires the king to leave its guard square and every reply to allow a mating capture; newly protecting the mating piece alone is not deflection. Both proofs use 4,096-visit caps, with existing deadlines unchanged. A fixed 20-position CC0 Lichess rare-theme audit includes 53 fresh engine searches and explicit contrary/pass controls; one primary and one other secondary result improve. All 180 private exact-input source/live replays and 32 frozen priorities remain unchanged, not certified accuracy successes. Verification: 1,331 selected tests, 506 production-worker inputs, lint, shared-review/app builds, three service and two dev-cache tests pass. The 135-input worker timing report has median/p95/max is 83/259/582 ms excluding engine/UI; cold HTTP first/next startup is 7,015/77 ms. The public timing receipt is benchmarks/tactical-relevance/built-worker-adapter81.json. See benchmarks/tactical-relevance/rare-theme-review.md and private-course-review.md for evidence and limits. Genuine zugzwang, quiet/rare combinations, the compensating-exchange false positive, the unrelated OTB type error and native verification remain open. No app/package/service was restarted or deployed; paid data stays private.
