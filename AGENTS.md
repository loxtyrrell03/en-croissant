...
- On 2026-09-14, adapter 98 / live pipeline 103 adds 23 fixed opening/middlegame/ending game contexts and all 23 actual after-move boards, with 106 public fresh engine searches. Quiet piece-and-pawn forks require complete named-target capture proofs; sufficient pairs are preferred, but the real Nf3 needs all three targets and all 27 replies. Its supporting pin stays at the actual capture ply, and missed-versus-allowed review keeps a larger hanging-knight cause primary. Checking/capturing entries, king-and-pawn-only pressure, exhausted work and off-square liabilities cannot use this new rule. Existing stronger proofs, worker deadlines and other proof limits remain unchanged. All 246 private source results and headline lists stay unchanged; one live continuation gains a verified later fork, supported by twenty replies and 21 additional fresh engine searches. Twenty rare results, 23 prior cross-phase results, 32 priorities and 386 prior public headline lists are unchanged, not certified accurate. Verification: 1,807 selected tests, 968 actual-controller worker inputs, builds, TypeScript, fifteen-file lint, three service tests, two cache scenarios and 26 isolated HTTP cases pass. Public worker median/p95/max is 70/231/837 ms excluding engine/UI. HTTP startup remains variable; older multi-second cold starts are not certified fixed. See benchmarks/tactical-relevance/broader-game-relevance-review.md and private-course-review.md for judgements, contrary controls, remaining misses and receipts. Broader quiet/rare/positional/ending/causal and native gaps remain; no owner app/package/service restart or deployment. Paid data stays private.
