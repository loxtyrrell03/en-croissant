...
- On 2026-09-14, adapter 96 / live pipeline 101 verifies two real mating deflections through checking entries, every interposition and actual mate, plus a king evasion's mating self-interference with sole-blocker and king-safety checks. The restoration/occupancy probes are hypothetical, not legal variations. Mate remains primary; specific support replaces generic sacrifice noise and a blocked rook route replaces future-line arrows. Eight contrary controls include absent/pinned guards that still leave mate, so missing mechanisms are not counted as tactical absence. Final proofs use 493 and 174 of 8,192 operations; self-interference retains 512. The public receipt validates 37 final fresh engine searches. All 246 private full results, twenty prior rare results, 32 priorities, 362 prior public headline lists and twenty other cross-phase full results are unchanged, not certified accurate. Three secondary explanations change without changing any of the 23 cross-phase primary IDs. Verification: 1,788 selected tests, 881 actual-controller worker inputs, builds, TypeScript, eleven-file lint, three service tests, two cache scenarios and twenty isolated HTTP cases pass. Public worker median/p95/max is 74/198/615 ms excluding engine/UI; first HTTP startup is 1,360 ms and previous multi-second variability remains contrary evidence. See benchmarks/tactical-relevance/mating-mechanism-relevance-review.md and private-course-review.md. Five cross-phase roots and broader quiet/secondary/positional/endgame/causal gaps remain; no owner app/package/service restart, deployment or native verification. Paid data stays private.
