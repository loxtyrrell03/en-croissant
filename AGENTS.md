...
- On 2026-09-14, adapter 90 / live pipeline 95 verifies drawing as well as winning KPK zugzwang, with honest draw labels, board geometry and missed/allowed causal comparisons. Spare pawn tempi, equal pass outcomes, terminal states and unavailable fifty-move bounds abstain. Unusable en-passant metadata after a double push no longer invalidates a three-piece probe. All 165,676 legal canonical zero-clock positions match the internal outcome-change rule (80 winning, 80 drawing); 38 independent Syzygy queries across nineteen structurally selected positions check both turns and 57 qualifying replies. Forty-two fresh depth-16 searches retain exact draw-versus-estimate distinctions. All 225 course/generated-game full results, twenty rare cases, 32 priorities and 177 previous public headlines remain unchanged, not certified accurate. Verification: 1,588 selected tests, final replay, 661 production-worker inputs, builds, type checking, lint, three service tests and two dev-cache scenarios pass. Public worker median/p95/max is 82/215/605 ms excluding engine/UI (different case mix); seven cold HTTP cases pass, not native reliability proof. See benchmarks/tactical-relevance/drawing-zugzwang-review.md and private-course-review.md. Larger-ending zugzwang, broader quiet/rare/causal classification and native verification remain open. No app/package/service was restarted or deployed; paid data stays private.
