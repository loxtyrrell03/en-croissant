...
- On 2026-09-14, adapter 103 / live pipeline 108 recognizes independently proved mating interference and prefers it over a conditional preparation of the same threat. Quiet new-mate proofs may establish pawn/exchange concessions but must exceed pre-existing captures; work budgets and checking/capturing thresholds are unchanged. The cut route must defeat a defence legal before the move; arrows show that route and mate threat, not a future capture. One course root now leads with Interference, and another retains Deflection with a ply-5 Mating Attack. Other 244 private full results, twenty rare results, 32 priorities and 727 prior public headline lists are unchanged, not certified accurate. Verification: 213 final fresh engine searches, eight retained-baseline inputs, 2,012 selected tests, 1,271 controller-worker inputs, 60 Chrome groups, 63 cold-HTTP cases, builds, TypeScript, eleven-file lint, three service tests and two cache scenarios. A rebuild interrupted three worker groups; they were rerun against the identical final artifact. Public worker median/p95/max is 71/260/1,564 ms excluding engine/network/native UI; cold first/next startup is 6,326/7,050 ms plus 7,218 ms server startup. A queen-trap prototype was withdrawn after countercapture-retention scrutiny despite winning engine choices; snAK4, ZVq1J and 4Ds65 root gaps and broader quiet/causal/endgame/native coverage remain open. See benchmarks/tactical-relevance/mating-interference-review.md and private-course-review.md for corrected chess judgements, exact receipts and limits. No owner app/package/service restart or deployment; paid data stays private.
