...
- On 2026-09-14, adapter 104 / live pipeline 109 proves quiet mating preparations independently of supplied PV length under the unchanged 16,384-operation cap. Complete legal-defence certificates include quiet follow-ups, counterchecks and promotions. A mating-backed material fork no longer adds a duplicate lesson beside independently forced mate; real interference support and actual-ply underpromotion remain. Quiet root board arrows no longer borrow arbitrary future replies. Nine output-blind real Lichess games recover or correct three root-only mate-in-three lessons; three longer mates remain coverage gaps. All 246 private full results, twenty rare results and 32 priorities are unchanged; 356 eligible quiet cross-phase inputs gain no short-mate claims, not accuracy certification. Verification: 203 fresh engine searches, eighteen retained-baseline inputs, 2,038 selected tests, 1,316 controller-worker inputs, 168 Chrome groups, 81 cold-HTTP cases, builds, TypeScript, twelve-file lint, three service tests and two cache scenarios. Four of 763 prior public headlines change in independently verified constructed mating controls. Public worker median/p95/max is 65/213/854 ms excluding engine/network/native UI; cold first/next startup is 2,820/68 ms with another 3,530 ms startup and separate 4,005 ms server startup. A multi-game source-test timeout and obsolete worker-count/UI expectations were corrected and rerun; production deadlines are unchanged. See benchmarks/tactical-relevance/quiet-mate-relevance-review.md and private-course-review.md for primary-theme judgements, complete receipts and retained quiet/causal/endgame/native gaps. No owner app/package/service restart or deployment; paid data stays private.
