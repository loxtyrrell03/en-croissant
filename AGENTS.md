...
- On 2026-09-12, adapter 83 / live pipeline 88 corrects a positional free-knight false positive through actual off-square countercaptures and checking exchanges under the unchanged 8,192-visit/two-response-round bounds. Guard deflection independently verifies the exact former defender's legal recapture and every accepting/declining reply; same surviving targets are required. Root/actual-ply arrows, missed move-order review and history-validated Material Recovery agree, while combined defender removal and specific intermediate checks keep priority over duplicate badges. Ninety-nine fresh engine searches include contrary best-move and wrong-capture-order evidence; local recovery is not a winning-game evaluation. All 180 source results, 179 live results, 20 rare-theme results, 32 priorities and 138 prior public worker headlines are unchanged; the one changed live variation adds a later Black pawn deflection, not its missing White root lesson. Verification: 1,371 selected tests, 514 production-worker inputs, lint, builds, three service and two dev-cache tests pass. Public worker median/p95/max is 81/231/550 ms excluding engine/UI; cold HTTP first/next startup is 7,605/68 ms. See benchmarks/tactical-relevance/private-course-review.md, rare-theme-review.md and exchange-defence-stockfish-18.json for proof limits and rejected assumptions. Genuine zugzwang, quiet/rare combinations, broader causal gaps, the unrelated OTB type error and native verification remain open. No app/package/service was restarted or deployed; paid data stays private.
