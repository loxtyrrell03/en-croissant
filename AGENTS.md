...
- On 2026-09-14, adapter 92 / live pipeline 97 adds eighteen output-blind real-game roots across six secondary-theme strata and 51 fresh engine searches. Intermediate-capture proofs cannot spend an all-mating sentinel as extra material. X-ray support requires actual exchange geometry and independent material/mate evidence; mating self-interference stays on the defender's actual ply. Mate leads, with compact supporting board arrows and missed-theme timelines. Pass probes reject two premature zugzwang hypotheses; larger-ending and setup gaps remain unproved. Four new explanations change, including a corrected mate headline; one old course continuation loses an unsupported x-ray badge. Other 245 full course/generated results, all 246 root headline lists, twenty rare results, 32 priorities and 219 prior public worker headlines are unchanged, not certified accurate. Verification: 1,657 selected tests, 797 actual-controller worker inputs, builds, TypeScript, ten-file lint, three service tests, two cache scenarios and ten isolated HTTP cases pass. Public worker median/p95/max is 74/201/618 ms excluding engine/UI; common-subset timing is 81/211/618 ms, not a speedup claim. Existing deadlines and prior proof budgets are unchanged. See benchmarks/tactical-relevance/secondary-theme-relevance-review.md and private-course-review.md for contrary controls and limits. Wider quiet/rare/causal classification, prepared traps, promotion combinations, larger-ending zugzwang and native verification remain open. No owner app/package/service restart or deployment; paid data stays private.
