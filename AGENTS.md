...
- On 2026-09-14, adapter 101 / live pipeline 106 links already-verified direct capture payoffs to their same-piece/same-target fork, discovery, pin or skewer. Different actors, lower-value incidental targets, interruptions, primary captures and specialized payoffs remain distinct; no new motif or value is admitted. Twenty fixed Black-root real-game contexts plus twenty actual reply boards and 71 fresh engine searches distinguish quiet development, conditional later mates, equal liquidations and genuine drawing tactics. A real Ne7+ discovery stays primary and Rxd7 becomes Discovery Payoff; Black's best recapture is not blamed for pre-existing danger. Nineteen of 246 private positions and two rare continuations change only payoff wording; every primary, other semantic field, 32 priorities and 549 previous public headlines remain unchanged, not certified accurate. Verification: 1,936 selected tests, 1,103 controller-worker inputs, 36 actual-browser groups including narrow/200% and keyboard details, 37 final isolated HTTP cases, builds, TypeScript, scoped lint, three service tests and two cache scenarios pass. Public worker mean/median/p95/max is 120/85/286/1,847 ms excluding engine/network/native UI; deadlines are unchanged. Cold startup varies from 1.1 to 10.2 seconds across retained runs, not certified fixed. See benchmarks/tactical-relevance/black-context-relevance-review.md and private-course-review.md for independent judgements, receipts and limitations. Wider quiet/rare/causal/endgame and native gaps remain open. No owner app/package/service restart or deployment; paid material stays private.
