...
var getStyles = function (primaryColor, position) {
    ...
    return {
        widget: __assign(__assign(__assign({ position: 'fixed' }, (isTop ? { top: '20px' } : { bottom: '20px' })), (isLeft ? { left: '20px' } : { right: '20px' })), { zIndex: 2147483647, fontFamily: '-apple-system, BlinkMacSystemFont, "Inter", "Segoe UI", "Roboto", Helvetica, Arial, sans-serif' }),
        buttonContainer: {
            position: 'relative',
        },
        button: {
