...
export type CoachBookLine = { lineId: string; lineKind: string; pgn: string; citation: string; matchedGamePly: number; matchedBookMoveIndex: number; matchedBookPly: number; playedSan: string; playedUci: string; bookMoveSan: string; bookMoveUci: string; playedMoveMatched: boolean; moves: CoachBookLineMove[] }
