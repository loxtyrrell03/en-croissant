  ...
  const settings: SettingItem[] = useMemo(
    () => [
      ...
      },
      {
        id: "engine-dock",
        category: "board",
        title: "Engine panel on every tab",
        description:
          "Show a compact engine panel below database, review, plan, practice, and info tabs.",
        keywords: ["engine", "analysis", "panel", "dock"],
        render: () => <SettingsSwitch atom={showEngineDockAtom} />,
      },
      {
        id: "engine-hotkeys",
        category: "board",
