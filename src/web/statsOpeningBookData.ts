// Generated from EloGuard lib/book.js (lichess-org/chess-openings, CC0).
// 3733 lines of [eco, name, san-line]. Do not edit by hand — regenerate
// from the EloGuard book instead.
const STATS_OPENING_BOOK: [string, string, string][] = [
...
export default STATS_OPENING_BOOK;
