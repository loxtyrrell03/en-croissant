...
- On 2026-07-19, the desktop Files and database libraries recovered from leaked
  ...
  Directory startup now recognizes only Outpost parity paths directly under
  the Windows Temp root as leaked verification state, removes those overrides,
  and falls back to the real Documents and app-data trees; normal custom
